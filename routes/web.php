...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware([\App\Http\Middleware\AdminMiddleware::class])->group(function () {
        ...
        Route::get('questions/subject/{subject}/baza/{baza}', [QuestionController::class, 'showBaza'])->name('questions.baza')->middleware('permission:questions.view');
        ...
        // Live Stream
        Route::get('live-stream', [App\Http\Controllers\Admin\LiveStreamController::class, 'index'])->name('live-stream.index')->middleware('permission:broadcast.view');
        Route::get('live-stream/stats', [App\Http\Controllers\Admin\LiveStreamController::class, 'getStats'])->name('live-stream.stats')->middleware('permission:broadcast.view');
        Route::post('live-stream/update', [App\Http\Controllers\Admin\LiveStreamController::class, 'update'])->name('live-stream.update')->middleware('permission:broadcast.send');
        Route::post('live-stream/toggle', [App\Http\Controllers\Admin\LiveStreamController::class, 'toggle'])->name('live-stream.toggle')->middleware('permission:broadcast.send');
