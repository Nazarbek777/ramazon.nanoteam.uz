...
const navItems = [
    ...
    { href: '/bookstore/debts',     label: 'Qarzlar' },
];
            ...
            <nav style="flex-grow: 1; padding: 8px 12px; display: flex; flex-direction: column; gap: 4px;">
                ...
                <template v-for="(item, i) in navItems" :key="item.href">
                    <Link :href="item.href"
                        ...
                        <!-- Analytics icon -->
                        <svg v-else-if="i===4" width="16" height="16" fill="none" viewBox="0 0 24 24" :stroke="isActive(item)?'#a5b4fc':'rgba(255,255,255,0.35)'" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                        </svg>
                        <!-- Arrivals icon -->
                        <svg v-else-if="i===5" width="16" height="16" fill="none" viewBox="0 0 24 24" :stroke="isActive(item)?'#a5b4fc':'rgba(255,255,255,0.35)'" stroke-width="2">
